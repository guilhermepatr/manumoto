  ...
  return (
    <View style={styles.container}>
      ...
      <CustomButton
        ...
        onPress={() => router.push("/(pages)/(home)/addMoto/addMoto")}
      />
      <CustomButton
        title="Adicionar Manutenção"
        onPress={() => router.push("/(pages)/(home)/addManutencao")}
      />
      <CustomButton
        title="Adicionar Abastecimento"
        onPress={() => router.push("/(pages)/(home)/addAbastecimento")}
      />
      <CustomButton
        title="Relatório"
        onPress={() => router.push("/(pages)/(home)/relatorio")}
      />
    </View>
  );
}
